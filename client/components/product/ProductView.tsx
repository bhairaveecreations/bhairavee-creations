    ...
    <section className="bg-[#F8F6F2] min-h-screen  pt-30  px-4 md:px-10 pb-10">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-16 items-start">
        ...
        <div className="flex flex-col">
          ...
          {/* TITLE */}
          <h1 className="text-2xl md:text-4xl font-serif text-[#2B1B14] leading-snug">
            {product.title}
          </h1>
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${selectedVariant?.name === v.name
                        ...
                        : "bg-white border-gray-300 text-gray-700 hover:border-[#C8A24A]"
                      }
                    `}
                  >
                    {v.name}
